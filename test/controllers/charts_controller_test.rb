...
class ChartsControllerTest < ActionController::TestCase
  ...
  test "should create chart" do
    assert_difference('Chart.count') do
      post :create, chart: { chord: @chart.chord, left_hand: @chart.left_hand, note: @chart.note, right_hand: @chart.right_hand }
    end
  ...
  test "should update chart" do
    patch :update, id: @chart, chart: { chord: @chart.chord, left_hand: @chart.left_hand, note: @chart.note, right_hand: @chart.right_hand }
    assert_redirected_to chart_path(assigns(:chart))
  end
